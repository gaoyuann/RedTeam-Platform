...
export const RBAC = {
  ...
  'topology':      { read: ['admin', 'teacher', 'operator', 'viewer', 'student'], write: ['admin', 'teacher', 'operator'] },
  'scan-tasks':    { read: ['admin', 'teacher', 'operator', 'viewer', 'student'], write: ['admin', 'teacher', 'operator'] },
  'runs':          { read: ['admin', 'teacher', 'operator', 'viewer', 'student'], write: ['admin', 'teacher', 'operator'] },
  'tools':         { read: ['admin', 'teacher', 'operator'],          write: ['admin', 'teacher', 'operator'] },
  'reports':       { read: ['admin', 'teacher', 'operator', 'viewer', 'student'], write: ['admin', 'teacher'] },
  ...
  'payloads':      { read: ['admin', 'teacher', 'operator', 'viewer', 'student'], write: ['admin', 'teacher', 'operator'] },
